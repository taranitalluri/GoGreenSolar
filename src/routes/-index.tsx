...
function Footer() {
  ...
  return (
    <footer ref={ref} style={{
      background:`linear-gradient(160deg,${C.footerBg},${C.headerBg})`,
      padding:"5rem 3rem 2rem",   /* ← was 3rem, now 5rem top to clear the wave SVG */
      position:"relative",
      zIndex:10,
      overflow:"hidden"
    }}>
      {/* Wave SVG sits at top:-2 (absolute), height 60px — padding-top must exceed this */}
      <svg style={{position:"absolute",top:-2,left:0,right:0}} viewBox="0 0 1440 60" preserveAspectRatio="none" height={60}>
        <path d={`M0,0 C480,60 960,0 1440,0 L1440,60 L0,60 Z`} fill={C.bg}/>
      </svg>
